...
\subsubsection{Der Wirkungsquerschnitt \texorpdfstring{$\sigma$}{}}

\subsubsection{Der Extinktionskoeffizient \texorpdfstring{$\mu$}{}}
...
Der wesentliche Bestandteil des Detektors ist eine Diode. Daher exestieren in dem Detektor-Kristall zwei an einander grenzende Bereiche, die p- bzw. n-dotiert sind (vgl. \cite[10]{V18}).


-Ladungsträger diffundieren
-es bleiben Ortsfeste Donatoren und Akzeptoren über
