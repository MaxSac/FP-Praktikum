...
\begin{equation}
  ...
  \label{}
\end{equation}
gelöst werden. Anhand der Lösung kann aus dem Poythingvektor abgeleitet werden das alle Beiträge verschwinden, außer wenn m die Zahlenwerte
\begin{equation}
  \Delta m = -1,0,1 
\end{equation}
...
Beim normalen Zeeman-Effekt verschwindet die Summe der einzelnen Spins ($S=0$), sodass der entsprechende Lande-Faktor für alle $J : g_\text{J} = 1$ ist. Dabei ist die Aufspaltung der einzelnenEnergieniveaus unabhängig von der Quantenzahl. Die Energiedifferenz der Übergänge kann mittels Formel \ref{egn:delE} berechnet werden. 
\subsection{Anomale Zeeman-Effekt}
Ist der Atomspin von Null verschieden, wird vom Anomalen Zeeman-Effekt gesprochen. Bei diesem kommt es aufgrund der Lande-Faktoren welcher von null verschieden ist zu mehr Aufspaltungen als beim normalen Zeeman-Effekt. Die Energiedifferenz der einzelenen Niveaus lässt sich durch die Formel 
\begin{equation}
  \Delta E = \mu_\text{B} (m_1 g_1 + m_2 g_1)
  \label{}
\end{equation}
berechenen. 
